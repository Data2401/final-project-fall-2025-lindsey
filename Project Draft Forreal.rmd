...
brand_l_ranges %>% ggplot(aes(x=min_lightness,y=total_range,color=brand_name)) + geom_point()
brand_l_ranges %>% ggplot(aes(x=max_lightness,y=total_range,color=brand_name)) + geom_point()
